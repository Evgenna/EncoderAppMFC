...
// EncoderApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CEncoderAppApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CEncoderAppApp

CEncoderAppApp::CEncoderAppApp()
{
...
// Единственный объект CEncoderAppApp

CEncoderAppApp theApp;


// Инициализация CEncoderAppApp

BOOL CEncoderAppApp::InitInstance()
{
